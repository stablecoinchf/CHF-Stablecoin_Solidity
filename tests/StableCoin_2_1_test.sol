...
contract testSuite {
    ...
    function testTransferFrom1() public {
        ...
        Assert.equal(coin.balanceOf(accountSpender), 100, "Incorrect balance");
        Assert.equal(coin.balanceOf(accountRecipient), 0, "Incorrect balance");
        ...
        Assert.equal(coin.balanceOf(accountSpender), 90, "Incorrect balance");
